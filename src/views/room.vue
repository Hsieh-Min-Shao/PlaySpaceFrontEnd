...
<template>
    <div class="play-audio">
        <button @click="startCall" ref="start">开始对讲</button>
        <button @click="stopCall" ref="stop">结束对讲</button>
    </div>
</template>
...
function startCall() {
    ...
    scriptNode.onaudioprocess = (audioProcessingEvent) => {
        ...
        if (audioSocket.value && audioSocket.value.readyState === WebSocket.OPEN&&audioSocket.value.readyState === 1) {
